...
public class ImadDBInsert {
	...
	private void insertProduct(int totalRecords) throws SQLException {
		...
		String sql4="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Ridley Liz SL40 Bicycle',3799.95,1,12)";
		String sql5="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Cannondale Trail 16 Bicycle - Children',469.95,1,1)";
		String sql6="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Runners Wooden Push Bicycle - Children',104.94,1,2)";
		String sql7="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Polygon Xtrada 6 1 x 11 Bike',1249.95,1,6)";
		String sql8="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('MEC Synergy Gore-Tex Jacket',469.95,2,4)";
		String sql9="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('MEC Fair Trade T-Shirt',29.95,2,7)";
		String sql10="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Patagonia Cotton Flannel Shirt ',86.94,2,10)";
		String sql11="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Brooks Long Sleeve Top',48.94,2,4)";
		String sql12="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Prana Aisley Swimsuit Tankini',49.93,2,7)";
		String sql13="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Castelli Long Sleeve Jersey',150,2,10)";
		String sql14="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Pearl Izumi Tank',69.95,2,12)";
		String sql15="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Darn Tough Sunset Socks',29.95,3,4)";
		String sql16="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Merrell Trail Running Shoes',74.93,3,7)";
		String sql17="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Brooks Road Running Shoes',125.95,3,10)";
		String sql18="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Salomon Gore-Tex Light Trail Shoes',199.95,3,12)";
		String sql19="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Merrell Waterproof Light Trail Shoes ',189.95,3,1)";
		String sql20="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Fubuki Niseko 2.0 Winter Boots',159.95,3,2)";
		String sql21="INSERT INTO IMAD_TPRODUCT (name, price, category_id, global_reorder_point) VALUES ('Timberland Rugged Waterproof Boots ',189.95,3,6)";
