		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IMAD",
									"targetURL": "#eclaurierimadimadui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"eclaurierimadimadui-display": {
								"semanticObject": "eclaurierimadimadui",
								"action": "display",
								"description": "IMAD UI",
								"title": "IMAD",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ec.laurier.imad.imadui",
									"url": sap.ui.require.toUrl("ec/laurier/imad/imadui")
								}
							}
						}
					}
